...
public class JSONHighlighter implements Highlighter {
    ...
    private static final String JSON_COLON = "(?<JSONCOLON>\\\\:)";
    private static final String JSON_COMMA = "(?<JSONCOMMA>,)";
    ...
    public StyleSpans<Collection<String>> computeHighlighting(String text) {
        ...
        while (matcher.find()) {
            String styleClass
                    ...
                    : matcher.group("JSONCOMMA") !=null ? "json_comma"
                    : matcher.group("JSONCOLON") != null ? "json_colon"
                    : null;
